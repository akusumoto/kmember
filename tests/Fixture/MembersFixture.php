...
class MembersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'status_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => false, 'default' => '1', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'members_ibfk_1' => ['type' => 'foreign', 'columns' => ['part_id'], 'references' => ['parts', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'members_ibfk_2' => ['type' => 'foreign', 'columns' => ['sex_id'], 'references' => ['sexes', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'members_ibfk_3' => ['type' => 'foreign', 'columns' => ['blood_id'], 'references' => ['bloods', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'members_ibfk_4' => ['type' => 'foreign', 'columns' => ['member_type_id'], 'references' => ['member_types', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'members_ibfk_5' => ['type' => 'foreign', 'columns' => ['status_id'], 'references' => ['statuses', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
'engine' => 'InnoDB', 'collation' => 'utf8_general_ci'
    ...
    public $records = [
        [
            ...
            'status_id' => 1,
            'created' => '2015-01-28 07:00:49',
            'modified' => '2015-01-28 07:00:49'
        ],
    ];
}
