...
class ActivitiesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'activities_ibfk_1' => ['type' => 'foreign', 'columns' => ['member_id'], 'references' => ['members', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
'engine' => 'InnoDB', 'collation' => 'utf8_general_ci'
    ...
    public $records = [
        [
            ...
            'created' => '2015-01-28 07:01:03',
            'modified' => '2015-01-28 07:01:03'
        ],
    ];
}
