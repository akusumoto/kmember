<div class="actions columns large-2 medium-3">
    <h3><?= __('Actions') ?></h3>
    <ul class="side-nav">
        <li><?= $this->Html->link(__('Edit Member Type'), ['action' => 'edit', $memberType->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Member Type'), ['action' => 'delete', $memberType->id], ['confirm' => __('Are you sure you want to delete # {0}?', $memberType->id)]) ?> </li>
        <li><?= $this->Html->link(__('List Member Types'), ['action' => 'index']) ?> </li>
        <li><?= $this->Html->link(__('New Member Type'), ['action' => 'add']) ?> </li>
...
<div class="memberTypes view large-10 medium-9 columns">
    <h2><?= h($memberType->name) ?></h2>
    <div class="row">
        <div class="large-5 columns strings">
            <h6 class="subheader"><?= __('Name') ?></h6>
            <p><?= h($memberType->name) ?></p>
        </div>
        <div class="large-2 columns numbers end">
            <h6 class="subheader"><?= __('Id') ?></h6>
            <p><?= $this->Number->format($memberType->id) ?></p>
        </div>
    </div>
</div>
<div class="related row">
    ...
    <?php if (!empty($memberType->member_histories)): ?>
    <table cellpadding="0" cellspacing="0">
        ...
        <?php foreach ($memberType->member_histories as $memberHistories): ?>
        <tr>
