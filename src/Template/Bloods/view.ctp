<div class="actions columns large-2 medium-3">
    <h3><?= __('Actions') ?></h3>
    <ul class="side-nav">
        <li><?= $this->Html->link(__('Edit Blood'), ['action' => 'edit', $blood->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Blood'), ['action' => 'delete', $blood->id], ['confirm' => __('Are you sure you want to delete # {0}?', $blood->id)]) ?> </li>
...
<div class="bloods view large-10 medium-9 columns">
    <h2><?= h($blood->name) ?></h2>
    <div class="row">
        ...
        <div class="large-2 columns numbers end">
            ...
            <p><?= $this->Number->format($blood->id) ?></p>
        </div>
    </div>
</div>
<div class="related row">
    ...
    <?php if (!empty($blood->member_histories)): ?>
    <table cellpadding="0" cellspacing="0">
        ...
        <?php foreach ($blood->member_histories as $memberHistories): ?>
        <tr>
...
<div class="related row">
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <?php foreach ($blood->members as $members): ?>
        <tr>
            <td><?= h($members->id) ?></td>
