...
<div class="related row">
    ...
    <?php if (!empty($status->member_histories)): ?>
    <table cellpadding="0" cellspacing="0">
        ...
        <?php foreach ($status->member_histories as $memberHistories): ?>
        <tr>
...
<div class="related row">
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <?php foreach ($status->members as $members): ?>
        <tr>
            <td><?= h($members->id) ?></td>
